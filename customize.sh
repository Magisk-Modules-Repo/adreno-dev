# Adreno Systemless Install Script
...
if [ "$suimg" ]; then
  mount_su;
  if [ ! -e /su/su.d/000adrenomount -a ! -e /magisk/adreno-dev/module.prop -a ! -e /sbin/.core/img/adreno-dev/module.prop -a ! -e /sbin/.magisk/img/adreno-dev/module.prop -a "$(which e2fsck)" ]; then
